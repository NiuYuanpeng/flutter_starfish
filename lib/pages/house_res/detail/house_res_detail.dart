...
import 'package:flutter_starfish/pages/house_res/detail/house_res_detail_vm.dart';
...
import '../../mine/booked/booked_house_page.dart';
...
class HouseResDetailPage extends StatefulWidget {
  ...
  @override
  State<HouseResDetailPage> createState() => _HouseResDetailPageState();
}

class _HouseResDetailPageState extends State<HouseResDetailPage> {
  HouseResDetailVM viewModel = HouseResDetailVM();
  @override
  void initState() {
    super.initState();
    //获取房源明细
    viewModel.getHouseDetailData(widget.id);
    //附近房源
            ...
            child: Scaffold(
                ...
                body: SingleChildScrollView(
                    child: Column(children: [
                      ...
                      //配套设施网格布局
                      Consumer<HouseResDetailVM>(builder: (context, vm, child) {
    ...
    return Padding(
        ...
        child: Row(
          children: [
            ...
            //收藏按钮
            Selector<HouseResDetailVM, bool>(builder: (context, collected, child) {
  ...
  ///房源图片banner
  Widget _banner() {
    return Consumer<HouseResDetailVM>(builder: (context, vm, child) {
      return BannerWidget(
  ...
  Widget _bannerPageCount() {
    return Align(
        ...
        child: Consumer<HouseResDetailVM>(
          builder: (context, vm, child) {
            ...
            return Container(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  // Selector<HouseResDetailVM, int>(builder: (context, child, index) {
  ...
  ///配套设施网格布局
  Widget _facilityGridWidget(HouseResDetail? detailData) {
  ...
  Widget _nearbyHouseResList() {
    return Container(
        ...
        child: Consumer<HouseResDetailVM>(builder: (context, vm, child) {
