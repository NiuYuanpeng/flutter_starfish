...
import 'package:flutter_starfish/pages/home/home_vm.dart';
...
import '../../common_ui/icon_text/icon_text.dart';
import '../../common_ui/scan/scan_page.dart';
import '../../common_ui/sliver/sliver_header.dart';
import '../../common_ui/title/app_text.dart';
import '../../route/route_utils.dart';
import '../house_res/detail/house_res_detail.dart';
...
class _HomePageState extends State<HomePage> {
            ...
            body: SafeArea(
              child: Padding(
                  ...
                  child: CustomScrollView(slivers: [
                    ...
                    //房源列表
                    Selector<HomeViewModel, List<HouseResData>?>(builder: (context, houseResList, child) {
                      return SliverList(
  ...
  ///banner轮播
  Widget _banner() {
    return Selector<HomeViewModel, List<HomeBannerData>?>(
